  ...
  return {
    ...
    wallet: function () {
      var _wallet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(helpers) {
        var createLegacyProviderInterface, networkName, _yield$Promise, ULIFrameProvider, network, provider;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                createLegacyProviderInterface = helpers.createLegacyProviderInterface, networkName = helpers.networkName;
                _context.next = 3;
                return new Promise(function (resolve) {
                  resolve(_interopNamespace(require('@unilogin/provider')));
                });

              case 3:
                _yield$Promise = _context.sent;
                ULIFrameProvider = _yield$Promise["default"];
                network = networkName(networkId);
                provider = ULIFrameProvider.create(network);
                return _context.abrupt("return", {
                  provider: provider,
                  "interface": _objectSpread({}, createLegacyProviderInterface(provider), {
