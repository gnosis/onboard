...
import { c as createProvider, i as isValidPath, g as generateAddresses } from './hd-wallet-4e3e9c1d.js';
import 'hdkey';
                      ...
                      case 3:
                        ...
                        return _context12.abrupt("return", new Promise(function (resolve, reject) {
                          TrezorConnect.ethereumSignMessage({
                            path: path,
                            message: stripHexPrefix(message.data),
                            hex: true
                          }).then(function (response) {
                            if (response.success) {
                              if (response.payload.address !== toChecksumAddress(address)) {
